...
var app3Infra = json(loadTextContent('./app3-infra.json'))
...
module postgresDatabaseModule './modules/postgres-flex-database.bicep' = {
  ...
  params: {
    ...
    settings: app3Infra.postgresDatabase
  }
}

module appModule './app3-app.bicep' = {
  name: 'appService'
  scope: resourceGroup(domainResourceGroup)
  params: {
    ...
    postgresDatabase: app3Infra.postgresDatabase.name
    ...
    websitesPort: 3000
    appServiceSettings: app3Infra.appService
  }
}
...
module frontDoorEndpointModule './modules/front-door-endpoint.bicep' = {
  ...
  params: {
    ...
    settings: app3Infra.frontDoorEndpoint
  }
}
