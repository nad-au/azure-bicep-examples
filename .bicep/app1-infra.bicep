...
var app1Infra = json(loadTextContent('./app1-infra.json'))
...
module postgresDatabaseModule './modules/postgres-flex-database.bicep' = {
  ...
  params: {
    ...
    settings: app1Infra.postgresDatabase
  }
}

module containerAppModule './app1-app.bicep' = {
  name: 'containerApp'
  scope: resourceGroup(domainResourceGroup)
  params: {
    ...
    postgresDatabase: app1Infra.postgresDatabase.name
    ...
    containerAppSettings: app1Infra.containerApp
  }
}
...
module frontDoorEndpointModule './modules/front-door-endpoint.bicep' = {
  ...
  params: {
    ...
    settings: app1Infra.frontDoorEndpoint
  }
}
